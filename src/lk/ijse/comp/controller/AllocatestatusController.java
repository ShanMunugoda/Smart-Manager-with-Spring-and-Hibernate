...
public class AllocatestatusController implements Initializable {
    ...
    public AllocatestatusController() {
        allocatestatusBO=AppInitializer.ctx.getBean(AllocateStatusBO.class);
        branchBO=AppInitializer.ctx.getBean(BranchBO.class);
        projectBO=AppInitializer.ctx.getBean(ProjectBO.class);
